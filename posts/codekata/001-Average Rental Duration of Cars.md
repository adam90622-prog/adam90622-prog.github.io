...
### **Problem Description**
The following table, CAR_RENTAL_COMPANY_RENTAL_HISTORY, contains rental history records for a car rental company.
...
### **Task**
Write an SQL query to retrieve a list of car IDs and their average rental durations (column name: AVERAGE_DURATION) from the CAR_RENTAL_COMPANY_RENTAL_HISTORY table for cars whose average rental duration is 7 days or more.
